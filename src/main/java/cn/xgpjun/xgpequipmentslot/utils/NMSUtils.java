...
public class NMSUtils {
    ...
    public static ItemStack toItem(String NBTString){
        ...
        if(item==null||item.getItemMeta()==null)
            item = MyItemBuilder.getMissingItem();
        return item;
    }
    ...
    public static ItemStack addTag(ItemStack item,String key,String tag){
        try {
    ...
    public static ItemStack addTag(ItemStack item){
        try {
            Object nmsItemStack = asNMSCopy.invoke(CraftItemStack,item);
            Object tags = getTag.invoke(nmsItemStack);
            if(tags==null){
            ...
            String key = "equipmentGuiItem";
            setString.invoke(tags,key,"justShow");
            setTag.invoke(nmsItemStack, tags);
            return (ItemStack) asCraftMirror.invoke(CraftItemStack,nmsItemStack);
        }catch (Exception e){
            e.printStackTrace();
    ...
    public static boolean checkTag(ItemStack item,String key,String tag) {
        if(tag==null)
            return false;
        try {
            Object nmsItemStack = asNMSCopy.invoke(CraftItemStack,item);
