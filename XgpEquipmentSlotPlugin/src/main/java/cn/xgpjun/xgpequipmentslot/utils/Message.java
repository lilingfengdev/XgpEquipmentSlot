...
public class Message {
    ...
    public static String apiAttribute;
    ...
    public static void init(){
        ...
        tag1 = getString("command.tag1","&b/xes tag addEquip <tag>");
        tag2 = getString("command.tag2","&a手持物品,向手中的物品添加装备tag,用于配置中装备的检验.");
        tag3 = getString("command.tag3","&b/xes tag remove");
        tag4 = getString("command.tag4","&a手持物品,移除本插件添加的tag");
        tag5 = getString("command.tag5","&b/xes tag addSet <tag>");
        tag6 = getString("command.tag6","&a手持物品,向手中的物品添加套装tag,用于配置中套装的检验.");
        ...
        apiAttribute = getString("API.Attribute","&a目前已注册的前置属性插件:&b{name}&a,作者:&6{author}&a,版本:&b{version}");
    }
